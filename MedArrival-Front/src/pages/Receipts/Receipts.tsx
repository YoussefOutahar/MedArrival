        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow divide-y divide-gray-200 dark:divide-gray-700">
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center py-12">
              ...
              <h3 className="text-sm font-medium text-gray-900 dark:text-white">No clients found</h3>
              <p className="text-sm text-gray-500 dark:text-gray-400">Get started by creating a new client.</p>
            </div>
          ) : (
